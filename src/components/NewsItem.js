...
export default function NewsItem(props) {
  return (
    <>
    <div className="card" style={{width: "18rem",backgroundColor:"#404040",border:"1px white solid"}}>
        ...
        <div className="card-body">
            ...
            <a href={props.newsUrl} target='_blank' rel="noreferrer" className="btn btn-dark btn-sm">Go somewhere</a>
        </div>
    </div>
    </>
  )
